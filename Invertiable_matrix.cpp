...
string temp,temp_ch="";
//==============================================================================================================================================================
string conver_input(string ss){
    string temp_input="";
    int space=0;
    for(int i=0;i<ss.length();i++){
        if(s.find(ss[i])){
                if(space == 0 && ss[i] != ' ')temp_input+=ss[i];
                if(space == 1 && ss[i] != ' '){
                    temp_input+=ss[i];
                    space=0;
                }
   ...
   getline(cin,temp);
    for(int i=0;i<row;i++){
        do{     do{
                    ...
                    k=0;
                    getline(cin,temp);//cout <<temp<<"a\n";
                }while(conver_input(temp)== "");
                temp=conver_input(temp);  temp=temp +" "; 
        ...
        cout<<"=======================================================================================\n";
        for(int i=0;i<row;i++){
            if(i == row/2)cout<<"Main Maxtrix of A =        ";else cout <<"                           ";
            for(int j=0;j<colum;j++) {
               if(j == 0){
                    if(a[i][j]<0){
                        cout<<"|"<<fixed<<setprecision(3)<<setw(4)<< a[i][j];
                    }else{
                        cout<<"| "<<fixed<<setprecision(3)<<setw(4)<< a[i][j];
                    }
